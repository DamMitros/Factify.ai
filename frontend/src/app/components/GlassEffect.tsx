...
//                 <h3 className="player__legend__title">All Of Me</h3>
//                 <span className="player__legend__sub-title">Nao</span>
//               </div>
//             </div>
...
//       <div className="container container--mobile container--inline">
...
//           <div className="glass-specular"></div>
//           <div className="glass-content">
//             <a className="glass-content__link" href="#">
...
//             </a>
//           </div>
//           {/* SVG filter powinien być tylko raz na stronie, nie duplikuj go w każdym komponencie! */}
//         </div>
//       </div>
//     </div>
//   );
